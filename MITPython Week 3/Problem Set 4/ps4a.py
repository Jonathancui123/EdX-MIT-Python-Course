...
def playHand(hand, wordList, n):
    ...
    * The hand finishes when there are no more unused letters or the user
    ...
    while calculateHandlen(hand) > 0:
        ...
        displayHand(hand)
        # Ask user for input
        userInput = input("Enter a word using the letters in your hand or enter '.' if you are out of words!")
        ...
        # Otherwise (the input is not a single period):
            ...
            if isValidWord(userInput, hand, wordList) != True:
                # Reject invalid word (print a message followed by a blank line)
                print("\nThat is an invalid word")
            # Otherwise (the word is valid):
            else:
                # Tell the user how many points the word earned, and the updated total score, in one line followed by a blank line
                wordScore = getWordScore(userInput, n)
                totalScore += wordScore
                print(userInput, "earned ", wordScore, " points! Total:", totalScore, "\n")
                # Update the hand 
...
def playGame(wordList):
    ...
    while True:
        ...
        #print("Your running score is", overallScore, "over", gamesPlayed, "games!")
        """
